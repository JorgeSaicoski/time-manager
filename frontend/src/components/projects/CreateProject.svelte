...
<div
  class="w-full max-w-2xl p-4 space-y-4 bg-gray-800 rounded-lg shadow-lg text-white"
>
  {#if message}
    <div
      class="w-full max-w-2xl p-4 space-y-0 bg-teal-400 rounded shadow-lg text-black"
    >
      {message}
    </div>
  {/if}
